...
@Component({
  selector: 'app-screen31acc',
  templateUrl: './screen31acc.component.html',
  styleUrl: './screen31acc.component.css'
})
export class Screen31accComponent implements OnInit, OnDestroy {
  ...
  public mytext_dataCodeDate: string;
  ...
  private webservice_availableRight(){
    ...
    //this.txtLog = str_authR + ' ### ' + JSON.stringify(this.webservice_requestRightJson);
